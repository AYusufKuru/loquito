...
export default async function FinancePage() {
  ...
  const labels: Record<string, string> = {
    ...
    taxRegion: t("finance.taxRegion"),
    purchaseTaxPercent: t("finance.purchaseTaxPercent"),
    salesTaxPercent: t("finance.salesTaxPercent"),
    purchaseTaxNote: t("finance.purchaseTaxNote"),
